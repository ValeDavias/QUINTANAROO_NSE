...
map.getView().fit([-9776030.928650, 2293599.962459, -9621197.043739, 2404823.390030], map.getSize());
    ...
    element: (() => {
        ...
        if (93 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Elaboración: Valeria Dávila Barrios.<br />Fuente: SCINCE 2020 con base en la metodología del AMAI.';
            }
